# Debian maintainer-script skeletons

These are referenced by `maintainer-scripts` in `[package.metadata.deb]`
(`crates/sigil-agent/Cargo.toml`). cargo-deb substitutes the `#DEBHELPER#`
